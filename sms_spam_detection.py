...
# Before calling sns.heatmap(), select only numerical features for correlation analysis.
...
ps = PorterStemmer() # Instantiate the PorterStemmer object
...
def transform_text(text):
    ...
    for i in text:
        y.append(ps.stem(i)) # Now ps is defined and can be used
...
# Use the 'x' and 'y' keywords to specify data
